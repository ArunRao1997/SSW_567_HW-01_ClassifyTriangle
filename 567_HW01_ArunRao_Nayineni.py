...
def classify_triangle(a, b, c):  # defining classify_triangle() function that accepts three parameters
    # if a > 0 and b > 0 and c > 0:
    #     if (a + b > c) and (b + c > a) and (c + a > b):
    # validating type of triangles
...
if __name__ == '__main__':
    classify_triangle()  # Invoking function calls via main
    right_angled()
